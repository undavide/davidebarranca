...
excerpt: "CEP5.2 has a bug affecting MacOS and non-US keyboards that may prevent AngularJS binding to work. Here's how to apply a patch to angular.js"
layout: post
...
![unmet-dependencies](/wp-content/uploads/2014/12/unmet-dependencies.png)
...
![missing-packages](/wp-content/uploads/2014/12/missing-packages.png)
...
![local-lib](/wp-content/uploads/2014/12/local-lib.png)
...
Are you having problems with AngularJS binding the model to an input field? Chances are you're on a Mac with non-US keyboard (and if you're not, your users can be). This is a known issue of CEP5.2. [Kris Coppieters](https://www.rorohiko.com "Rorohiko Workflow Resources") came up with an Angular patch that you can apply - if you're lazy, just grab the patched version of [Angular-1.2.9](/wp-content/uploads/2014/12/angular-1.2.9.zip) and [Angular-1.3.5](/wp-content/uploads/2014/12/angular-1.3.5.zip).
